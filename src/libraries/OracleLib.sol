 ...
 *
 * So, if the Chainlink network explodes and you have a lot of money locked in the protocol, you can be sure that the protocol will not be able to mint new DSC.
 */
library OracleLib {
